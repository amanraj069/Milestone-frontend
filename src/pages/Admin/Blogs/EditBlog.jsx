...
const EditBlog = () => {
  ...
  const fetchBlog = async () => {
    try {
      ...
      const slugUrl = `${apiBaseUrl}/api/admin/blogs/by-slug/${encodeURIComponent(slug)}`;
      const idUrl = `${apiBaseUrl}/api/admin/blogs/by-id/${encodeURIComponent(blogId || slug)}`;
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      if (imageFile) {
        ...
        const uploadResponse = await fetch(`${apiBaseUrl}/api/admin/blogs/upload-image`, {
          method: 'POST',
          credentials: 'include',
          body: formData,
        });
      ...
      const response = await fetch(`${apiBaseUrl}/api/admin/blogs/${blog.blogId}`, {
        method: 'PUT',
